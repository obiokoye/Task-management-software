        ...
        <div class="row">
            <div class="col-md-12">
                <div class="card-box">
                    ...
                    <form method="POST" action="{{ route('body.update', $body) }}">
                        @csrf
                        @method('PUT')
                        <div class="form-row">
                            <div class="form-group col-md-6">
                                <label for="name" class="col-form-label">Body Name</label>
                                <input type="text" name="name" class="form-control" id="name" value="{{ $body->name }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="address" class="col-form-label">Body Address</label>
                                <input type="address" name="address" class="form-control" id="address" value="{{ $body->address }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="phone" class="col-form-label">Body phone</label>
                                <input type="tel" name="phone" class="form-control" id="phone" value="{{ $body->phone }}">
                            </div>
                            <div class="form-group col-md-6">
                                <label for="amount" class="col-form-label">Body Amount</label>
                                <input type="text" name="amount" class="form-control" id="amount" value="{{ $body->amount }}">
                            </div>
                        </div>
