                ...
                <div class="row">
                    ...
                    <div class="col-md-6  col-xl-3">
                        <div class="card-box mb-0 widget-chart-two shadow-none" dir="ltr">
                            <div class="float-right">
                                <input data-plugin="knob" data-width="80" data-height="80" data-linecap=round
                                       data-fgColor="#2d7bf4" data-bgColor="#404a57" value="60" data-skin="tron" data-angleOffset="180"
                                       data-readOnly=true data-thickness=".1"/>
                            </div>
                            <div class="widget-chart-two-content">
            ...
            <div class="card-box">
                ...
                <div class="table-responsive">
                    <table class="table table-hover table-centered m-0">
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backendassets/images/users/avatar-2.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backendassets/images/users/avatar-3.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backendassets/images/users/avatar-4.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backendassets/images/users/avatar-5.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                            </td>
                        ...
                        <tr>
                            <td>
                                <img src="{{ asset('backendassets/images/users/avatar-6.jpg') }}" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                            </td>
